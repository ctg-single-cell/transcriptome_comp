#Created by Fallon Ratner on 26.07.23
library(Seurat)
library(dplyr)
library(HGNChelper)
library(ggplot2)
...
library(reticulate)
###############################
setwd("C:/Users/fallo/Documents/Internship_2023/transcriptome_comp/output/Integration/Vitro_Int_26_7")
#Convert h5ad to seurat obj
ad <- read_h5ad("gian_26_7.h5ad")
ad <- read_h5ad("mengu1m_26_7.h5ad")
ad <- read_h5ad("mengu2f_26_7.h5ad")
ad <- read_h5ad("vel3mo_26_7.h5ad")
ad <- read_h5ad("vel6mo_26_7.h5ad")
ad <- read_h5ad("truj1mo_26_7.h5ad")
ad <- read_h5ad("truj3mo_26_7.h5ad")
ad <- read_h5ad("truj6mo_26_7.h5ad")
ad <- read_h5ad("truj10mo_26_7.h5ad")
...
pdf("umap_truj10mo_noannot26_7.pdf")
...
pdf("sctype_umap_annot_truj10mo_26_7.pdf")
...
pdf("umap_gaba_truji10mo_noannot26_7.pdf")
...
pdf("sctype_umap_in_annot_truj10mo_26_7.pdf")
DimPlot(gaba, reduction = "UMAP", label = FALSE, pt.size = 0.5, group.by = 'customclassif')        
dev.off()


write.csv(sctype_scores, file = "truj10mo_sctype26_7.csv", row.names = TRUE)
write.csv(sctype_scores2, file = "truj10mo_sctype_INs_26_7.csv", row.names = TRUE)
