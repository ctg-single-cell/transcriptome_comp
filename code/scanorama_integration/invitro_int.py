...
#Xiang 30, 72, 79 days
#xiang = sc.read_10x_mtx('C:/Users/fallo/Documents/Internship_2023/transcriptome_comp/data/Xiang', var_names='gene_symbols', cache=True)

#Assign the age & author as a new column in the metadata as Source
#import re

#check where the age info is stored first!
# Extract the string before the underscore from the cell names
#age_info = []
#for cell_name in xiang.obs_names:
#    match = re.search(r'(.+?)_', cell_name)
#    if match:
#        age_info.append(match.group(1)+ "_Xiang")
#    else:
#       age_info.append('Unknown')
# Create a new column in the metadata and assign the extracted age information to it
#xiang.obs['Source'] = age_info

dataset_list = [vel3, vel6, truj1, truj3, truj6, truj10, gian, mengu1, mengu2]  
